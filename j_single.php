                ...
                <div class="col">
                    ...
                    <div class="page-title">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="jew_product.php">Products</a></li>
                            <li class="breadcrumb-item active"><?php echo $row["jewelery_brand"] ?></li>
                            <li class="breadcrumb-item active"><?php echo $row["jewelery_name"] ?></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row learts-mb-n40">
                ...
                <div class="col-lg-6 col-12 learts-mb-40">
                    ...
                    <?php
                    if ($row["jew_status"] == "sale") {
                    ?>
                        <div class="center" class="center" style="box-shadow: 0 0 50px cornflowerblue;font-weight:bold;background-color:cornflowerblue;color:white ;width:70px;height:70px;border-radius:50%;display:flex;align-items:center;text-align:center;letter-spacing:1px;">
                            <p style="padding-left:4px;">
                                &nbsp; SALE
                            </p>
                        </div>
                    <?php } else if ($row["jew_status"] == "out") { ?>
                        <div class="center" class="center" style="box-shadow: 0 0 50px #c61932;font-weight:bold;background-color:#c61932;color:white ;width:70px;height:70px;border-radius:50%;display:flex;align-items:center;text-align:center;letter-spacing:1px;">
                    ...
                    <div class="product-images">
                        ...
                        <button class="product-gallery-popup hintT-left" data-hint="Click to enlarge" data-images='[
                            {"src": "../learts/jewellery images/<?php echo $row["jew_images"] ?>", "w": 900, "h": 1100}
                        ...
                        <div class="product-gallery-slider">
                            ...
                            <div class="product-zoom" data-image="assets/images/product/single/7/product-zoom-1.webp">
                                <img src="../learts/jewellery images/<?php echo $row["jew_images"] ?>" alt="">
                            </div>
                            <div class="product-zoom" data-image="assets/images/product/single/7/product-zoom-2.webp">
                                <img style=" transform: rotateY(180deg);" src="../learts/jewellery images/<?php echo $row["jew_images"] ?>"" alt="">
                            </div>
                        ...
                        <div class=" product-thumb-slider">
                                ...
                                <div class="item">
                                    <img src="../learts/jewellery images/<?php echo $row["jew_images"] ?>" p" alt="">
                                </div>
                                <div class="item">
                                    <img style=" transform: rotateY(180deg);" src="../learts/jewellery images/<?php echo $row["jew_images"] ?>""  alt="">
                            </div>
                ...
                <div class=" col-lg-6 col-12 learts-mb-40">
                                    <div class="product-summery">
                                        ...
                                        <?php
                                        $done = 0;
                                        $done = $row["jew_price"] - ($row["jew_price"] * $row["jew_discount"]);
                                        if ($row["jew_status"] == "sale") {
                                        ...
                                        ?>
                                            ...
                                            <div class="product-price">
                                                <span>
                                                    ...
                                                    <del style="color:red;">Rs: <?php echo $row["jew_price"] ?>/=</del>
                                                    </br>
                                                    </br>
                                                    <h5>Rs: <?php echo $done ?> /=<span class="badge rounded-pill bg-success"><?php echo ($row["jew_discount"] * 100) . "%" ?>
                                                            Off</span></h5>
                                                </span>
                                        ...
                                        <div class="product-description">
                                            <p>
                                                : ornamental pieces (such as rings, necklaces, earrings, and bracelets) that are made of materials which may or may not be precious (such as gold, silver, glass, and plastic), are often set with genuine or imitation gems, and are worn for personal adornment a collection of valuable jewelry a jewelry store
                                            </p>
                                            <p> a retail business establishment, that specializes in selling (and also buying) jewellery and watches. Jewellery stores provide many services such as repairs, remodeling, restoring, designing and manufacturing pieces.</p>
                                        </div>
                                        ...
                                        ?>
                                            <div class="product-buttons">
                                                <a href="cart.php?j_id=<?php echo $rows['id'] ?>" class="btn btn-dark btn-outline-hover-dark"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                            </div>
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="value">
                                                            <?php echo $row["jew_datetime"] ?>-<?php echo $row["id"] ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label"><span>Category</span></td>
                                                        <td class="value">
                                                            <ul class="product-category">
                                                                <li><a href="#"><?php echo $row["jewelery_category"] ?></a>
                                                                </li>
